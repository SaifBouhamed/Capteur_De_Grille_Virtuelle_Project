...
def get_one_frame():
    ...
    # 1. Config
    try:
        # --- MODIFICATION ICI : On écoute le traducteur ---
        topic = '/real_pointcloud' 
        ...
        # 3. Variable pour stocker le message
        ...
        while rclpy.ok():
            ...
            if captured_msg['data'] is not None:
                ...
                # Le traducteur publie déjà en base_link, mais on garde la TF par sécurité
...
def publish_marker(xyz_points, tf, pub, node):
    ...
    grid_n = 40
    cell = 2.0 / grid_n
    base_h = 0.00 # Base à 0
    h_map = {}
    
    # Filtrage zone 2m x 2m
    ...
    # --- MODIFICATION TAILLE ICI (Petites sphères) ---
    ratio_taille = 0.3 
...
def main(args=None):
    ...
    print("--- PHOENIX NODE DÉMARRÉ (Écoute /real_pointcloud) ---")
